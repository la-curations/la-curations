        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left lg:order-2">
            ...
            <p className="text-lg lg:text-xl text-white/40 leading-relaxed">
              Use advanced filters including content type, genres (with ALL|ANY
              logic), cast, crew, and OTT availability. Save your settings to
              instantly personalize your experience. Customize a whole screen
              with your saved filters.
            </p>
          </div>
        </div>
      </div>
